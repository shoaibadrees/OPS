...
{
    public abstract class OPSWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static OPSWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(OPSWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<OPSDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<OPSDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<OPSDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<OPSDbContext, Task<T>> func)
        {
            T result;
